        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 header-m">
                    ...
                    <div><a href="free-course"><button class="enroll-header" style="visibility: hidden;">Дознај повеќе</button></a></div>
...
<!-- 
    ...
    <!--WHY CREATIVEHUB END-->
    <div class="text-center mt-5 mb-5"><a href="#academy"><button class="academy-btn f-24">Аплицирај за Академијата</button></a></div>
    <!-- ALUMNI -->
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <div class="eu-academy-radio calculator-radio-margin-right">
                                <div class="d-flex align-items-center">
                                    <input id="eu-academy" type="radio" name="academy-price" value="2100">
                                    <label for="eu-academy">2100 €</label>
                                </div>
                            ...
                            <div class="eu-academy-radio calculator-radio-margin-right">
                                <div class="d-flex align-items-center">
                                    <input id="all-academy" type="radio" name="academy-price" value="2450">
                                    <label for="all-academy">2450 €</label>
                                </div>
